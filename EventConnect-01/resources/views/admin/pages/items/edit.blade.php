    ...
    <div class="">
        <div class="bg-white rounded-xl shadow-md p-8">
            <div class="flex justify-between items-center mb-8 border-b pb-4">
                <h2 class="text-2xl font-semibold text-gray-800">Editar Item de Menu</h2>  
            </div>

            <!-- Formulário para Editar Item de Menu -->
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @if ($item->id_img)
                                <img src="{{ asset('storage/' . $item->id_img) }}" alt="Imagem atual" class="mt-2 w-32 h-32 object-cover rounded-md">
                            @endif
                        </div>
                    </div>
                </div>
