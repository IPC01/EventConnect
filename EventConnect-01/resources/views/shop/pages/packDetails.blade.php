            ...
            <div class="bg-gradient-to-r from-purple-600 to-purple-800 text-white p-8">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="mb-4 lg:mb-0">
                        <h1 class="text-3xl lg:text-4xl font-bold mb-2">{{ $package->name ?? 'Nome do Pacote' }}</h1>
                    ...
                    <div class="text-right">
                        <div class="text-4xl font-bold mb-2">
                            R$ {{ number_format($package->price ?? 2500, 2, ',', '.') }}
                        </div>
                        <p class="text-purple-200">Preço total do pacote</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center text-gray-600">
                                        ...
                                        <a href="{{ $eventhall->website }}" target="_blank" class="text-purple-600 hover:text-purple-800">
                                            Website do salão
                                        </a>
                                    </div>
                                    @endif
                            ...
                            <div>
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <p class="text-sm text-gray-500">Valor do salão</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="grid gap-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg hover:shadow-md transition-shadow">
                                <div class="flex items-center space-x-4">
                                    @if($item->base_img)
                                    <img src="{{ $item->base_img }}" alt="{{ $item->name }}" class="w-16 h-16 rounded-lg object-cover">
                                    @else
                                    <div class="w-16 h-16 bg-gradient-to-br from-pink-200 to-purple-200 rounded-lg flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600">{{ $decoration->description ?? 'Decoração elegante e personalizada para tornar seu evento único e memorável.' }}</p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div class="group relative overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow">
                                    <img src="{{ $image->url ?? $image }}" alt="Decoração" class="w-full h-32 object-cover group-hover:scale-105 transition-transform duration-300">
                        ...
                        <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg p-4 text-center">
                            <div class="text-2xl font-bold text-yellow-600">
                                R$ {{ number_format($decoration->price ?? 800, 2, ',', '.') }}
                            </div>
                            <p class="text-sm text-gray-500">Valor da decoração</p>
                        </div>
                    </div>
                </div>
                @endif
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 sticky top-6">
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            ...
                            <span class="font-semibold">R$ {{ number_format($eventhall->price ?? 1200, 2, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            <span class="text-gray-600">Cardápio</span>
                            <span class="font-semibold">R$ {{ number_format($menu->sum('price') ?? 600, 2, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            <span class="text-gray-600">Decoração</span>
                            <span class="font-semibold">R$ {{ number_format($decoration->price ?? 800, 2, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 font-bold text-lg">
                            <span>Total</span>
                            <span class="text-purple-600">R$ {{ number_format($package->price ?? 2500, 2, ',', '.') }}</span>
                        </div>
                    </div>
                    
                    <button class="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                ...
                <div class="bg-gradient-to-br from-purple-50 to-cyan-50 rounded-xl p-6">
                    ...
                    <p class="text-sm text-gray-600 mb-4">Entre em contato conosco para mais informações ou personalização do pacote.</p>
                    <button class="w-full bg-white text-purple-600 border border-purple-200 hover:bg-purple-50 font-semibold py-2 px-4 rounded-lg transition-colors">
                        Falar com Consultor
                    </button>
                </div>
            </div>
